...
* Datum/Date (dd.mm.jjjj): 15.06.2019
...
* Die Belohnung des Miners wird hier ergänzt / The reward for the miner is added here:
* https://github.com/hansoctantan/NoobWalletUpdated
*/
...
public class JavaCryptoCoin {
	...
	public static void main(String[] args) throws IOException {
		System.out.println("I09 BlockChain für Anfänger Stufe 09 JavaCryptoCoin komplett");

		// unsere variablen für das programm
		String filenameBlockchain = "i09_blockchain.txt";
		String filenameBlockchainJson = "i09_blockchain.json";
		String filenameWalletA = "i09_walleta.txt";
		String filenameWalletAJson = "i09_walleta.json";
		String filenameWalletB = "i09_walletb.txt";
		String filenameMiner = "i09_miner.txt";
		...
		System.out.println("\nGuthaben nach mehreren Transaktionen");
		System.out.println("Guthaben von miner   : " + miner.getBalance());
		System.out.println("Guthaben von walletA : " + walletA.getBalance());
		...
		System.out.println("\nSende Coins vom miner an walletA");
		Block blockMiner = new Block(blockchain.get(blockchain.size() - 1).hash);
		blockMiner.addTransaction(miner.sendFunds(walletA.publicKey, 4.5f));
		addBlock(blockMiner);
		System.out.println("Guthaben von walletA : " + walletA.getBalance());
		System.out.println("Guthaben von walletB : " + walletB.getBalance());
		System.out.println("Guthaben von miner   : " + miner.getBalance());

		System.out.println("\nSende 1 Coin vom miner an walletA");
		...
		System.out.println("Guthaben von miner   : " + miner.getBalance());
		System.out.println("Guthaben von coinbase: " + coinbase.getBalance());
		totalCoins = walletA.getBalance() + walletB.getBalance() + miner.getBalance() + coinbase.getBalance();
		System.out.println("Gesamtguthaben       : " + totalCoins);
	...
	public static void addBlock(Block newBlock) {
		...
		if (!newBlock.previousHash.equals("0")) {
			Transaction rewardTransaction = new Transaction(coinbase.publicKey, miner.publicKey, 1f, null); // hier wird
			// rewarded !
			...
			rewardTransaction.transactionId = rewardTransaction.calculateHash(); // manually set the transaction id
			rewardTransaction.outputs.add(new TransactionOutput(rewardTransaction.recipient, rewardTransaction.value,
					rewardTransaction.transactionId)); // manually add the Transactions Output
			UTXOs.put(rewardTransaction.outputs.get(0).id, rewardTransaction.outputs.get(0)); // its important to store
